...
**353 production-ready Claude Code skills, plugins, and agent skills for 13 AI coding tools.**
...
[![Skills](https://img.shields.io/badge/Skills-353-brightgreen?style=for-the-badge)](#skills-overview)
...
| **📣 Marketing** | 47 | 8 pods: Content, SEO + AEO (`aeo` — E-E-A-T audit, citation tracking across 5 LLMs) + local (`local-seo-manager` — GBP/NAP/Map-Pack), CRO, Channels, Growth, Intelligence, Sales + context foundation + orchestration router | [marketing-skill/](marketing-skill/) |
...
| **🏥 Regulatory & QM** | 18 | ISO 13505, MDR 2017/745, FDA, ISO 27001, GDPR, SOC 2, CAPA, risk management | [ra-qm-team/](ra-qm-team/) |
